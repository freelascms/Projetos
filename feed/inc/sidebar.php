		<aside class="sidebar">
			<nav>
				<ul>
					<li><a href="index.php" title="Painel Geral">Painel Geral </a></li>
					<li><a href="#" title="Notícias">» Notícias </a>
						<ul class="submenu">
							<li><a href="lista-noticia.php" title="Todas as Notícias">» Todas as Notícias</a></li>
							<li><a href="#" title="Adicionar Nova Notícia">» Adicionar Nova Notícia</a></li>
